...
def game(window):
    ...
    while run:
        ...
        cooldown1 = handle_arrows(player1, p1_arrows, offset_x, joysticks[0], cooldown1)
        cooldown2 = handle_arrows(player2, p2_arrows, offset_x, joysticks[1], cooldown2)
